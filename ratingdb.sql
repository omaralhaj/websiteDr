...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 12, 2017 at 02:58 AM
...
INSERT INTO `college` (`ID`, `Name`, `ArabicName`, `Description`, `Logo`) VALUES
...
(2, 'pharmacy', 'كلية الصيدلة', '.\nتم إنشاء كلية الصيدلة عام 1397هـ (1959م) بعد إنشاء جامعة الملك سعود بعامين\n<br><br>\n\n.\n<b>أقسام الكلية:</b>\nالصيدلة الإكلينية، الكمياء الصيدلية، علم الأدوية والسموم، قسم الصيدلانيات وقسم العقاقير', 'logo\\pharmacyLogo.jpg'),
...
(4, 'medicine', 'كلية الطب', '<b>أقسام الكلية:</b>\nقسم الأشعة، قسم الأنف والحنجرة، قسم الباطنة، قسم التخدير، قسم التشريح، قسم التعليم الطبي، قسم الجراحة، قسم الطب النفسي، قسم العناية المركزة، قسم جراحة العظام، قسم طب الأسرة والمجتمع، قسم طب الأطفال، قسم طب الأمراض الجلدية، قسم طب الطوارئ، قسم طب النساء والولادة، قسم طب وجراحة العيون، قسم علم الأمراض، قسم علم وظائف الأعضاء، وقسم علوم القلب', 'logo\\ksuLogo.png'),
(5, 'dent', 'كلية طب الأسنان', '."\r\n<b>رؤية الكلية:</b>\r\n "أن نكون كلية قائدة إقليمياً ومميزة عالمياً في إنتاج معرفة طب الأسنان واستخدامه\r\n<br><br>\r\n\r\n<b>أقسام الكلية:</b>\r\nقسم جراحة الوجه والفكين، قسم طب الفم وعلوم التشخيص، قسم طب أسنان الأطفال وتقويم الأسنان، قسم الأنسجة المحيطة بالأسنان وصحة أسنان المجتمع، قسم علوم الإستعاضة السينية، وقسم علوم إصالح الأسنان', 'logo\\ksuLogo.png'),
(6, 'pscems', 'كلية الأمير سلطان للخدمات الطبية الطارئة', '.\nتعد من أول الكليات التي تم إنشاؤها في مجال الخدمات الطبية الطارئة في المملكة\n.\nتم إنشاءها عام 1429هـ\n<br>\n."\n<b>رؤية الكلية:</b>\n "ريادة إقليمية وتميز عالمي في إعداد مخرجات منافسة ومبدعة في تخصصات العلوم الطبية الطارئة\n<br><br>\n\n<b>أقسام الكلية:</b>\n قسم الخدمات الإسعافية، قسم العلوم الأساسية، قسم الإصابات والحوادث، وقسم الإسعاف الجوي والبحري', 'logo\\pscemsLogo.png'),
(7, 'arts', 'كلية الآداب', '.\nتعد كلية الآداب أول كلية أنشئت في جامعة الملك سعود\n<br><br>\n\n<b>أقسام الكلية:</b>\nقسم اللغة العربية و آدابها، قسم اللغة الانجليزية وآدابها، قسم التاريخ، قسم الجغرافيا، قسم الإعلام، قسم الدراسات الاجتماعية، وقسم علوم المكتبات والمعلومات', 'logo\\artsLogo.jpg'),
(8, 'csspa', 'كلية علوم الرياضة والنشاط البدني', '<b>أٌقسام الكلية:</b>\n قسم الإداراة الرياضية والترويحية، قسم التربية البدنية، قسم الميكانيكا الحيوية والسلوك الحركي، وقسم فسيولوجيا الجهد البدني', 'logo\\ksuLogo.png'),
(9, 'cta', 'كلية السياحة والآثار', '."\n<b>رؤية الكلية:</b> \n"التميز في التعليم السياحي والآثاري والبحث العلمي وخدمة المجتمع\n<br><br>\n\n<b>أقسام الكلية:</b>\n قسم الآثار، قسم إدارة موارد التراث والإرشاد السياحي، وقسم الإدارة السياحية والفندقية', 'logo\\ksuLogo.png'),
(10, 'clps', 'كلية الحقوق والعلوم السياسية', '."\n<b>رؤية الكلية:</b>\n "الريادة والتميز في مجال الحقوق والعلوم السياسية إقليميًا وعالميًا في التعليم والبحث العلمي وخدمة المجتمع\n<br><br>\n\n.\n<b>أقسام الكلية:</b>\nقسم القانون الخاص، قسم القانون العام، وقسم العلوم السياسية', 'logo\\clpsLogo.jpeg'),
(11, 'education', 'كلية التربية', '<b>أٌقسام الكلية:</b>\nقسم  السياسات التربوية، قسم  علم النفس، قسم  الثقافة الإسلامية، قسم المناهج وطرق التدريس، قسم التربية الفنية، قسم تقنيات التعليم، قسم التربية الخاصة، قسم الادارة التربوية، وقسم الدارسات القرآنية', 'logo\\ksuLogo.png'),
(12, 'ali', 'معهد اللغويات العربية', '."\n<b>رؤية الكلية:</b>\n "الريادة العالمية والمرجعية العلمية في برامج اللغة العربية لغير الناطقين بها\n<br><br>\n\n<b>أقسام الكلية:</b>\nقسم اللغة والثقافة، قسم اللغويات التطبيقية، قسم تدريب المعلمين وقسم الطالبات', 'logo\\ksuLogo.png'),
(13, 'colt', 'كلية اللغات والترجمة', '."\n<b>رؤية الكلية:</b> \n"ريادة عالمية في مجالي اللغات والترجمة، ونافذة للتواصل مع ثقافات الشعوب وحضاراتها، للإسهام في بناء مجتمع المعرفة\n<br><br>\n\n<b>أقسام الكلية:</b>\nقسم اللغة الأنجليزية والترجمة، قسم اللغة الفرنسية والترجمة، قسم اللغات الحديثة والترجمة، وقسم اللسانيات ودراسات الترجمة', 'logo\\ksuLogo.png'),
(14, 'sciences', 'كلية العلوم', '.(\nتعد كلية العلوم ثاني كلية تم إنشاءها في جامعة الملك سعود في عام 1378هـ (1958م\n<br>\n."\n<b>رؤية الكلية:</b>\n " الريادة في العلوم الأساسية وتطبيقاتها وثقافتها للمساهمة في بناء مجتمع المعرفة\n<br><br>\n\n<b>أقسام الكلية:</b>\n قسم الاحصاء والبحوث العلمية، قسم الجيولوجيا، قسم الرياضيات، قسم علم الحيوان، قسم الفيزياء والفلك، قسم الكيمياء، قسم الكيمياء الحيوية، وقسم النبات والأحياء الدقيقة', 'logo\\ksuLogo.png'),
(15, 'ccis', 'كلية علوم الحاسب والمعلومات', '."\n<b>رؤية الكلية:</b>\n " الريادة في التعليم والبحث العلمي في مجالات الحوسبة وتقنية المعرفة\n<br><br>\n\n\n<b>أٌقسام الكلية:</b>\n قسم علوم الحاسب، قسم هندسة الحاسب، قسم نظم المعلومات، قسم هندسة البرمجيات، وقسم تقنية المعلومات ومساراته: مسار الشبكات والأمن، مسار إدارة البيانات، ومسار تقنية الويب والوسائط المتعددة', 'logo\\ccisLogo.png'),
(16, 'engineering', 'كلية الهندسة', '.\nأُنشئت كلية الهندسة عام 1382 للهجرة الموافق لعام 1962 للميلاد كمشروع مشترك بين حكومة المملكة العربية السعودية ومنظمة التربية والثقافة والعلوم الدولية اليونسكو\n<br>\n.\n انضمت الكلية إلى جامعة الملك سعود عام 1388 للهجرة الموافق لعام 1968 للميلاد\n<br>\n<br>\n<b>أقسام الكلية:</b>\n قسم الهندسة المدنية، قسم الهندسة الكهربائية، قسم الهندسة الكيميائية، قسم الهندسة الميكانيكي ، قسم الهندسة الصناعية، وقسم هندسة البترول والغاز الطبيعي', 'logo\\ksuLogo.png'),
(17, 'cba', 'كلية إدارة الأعمال', '."<b>رؤية الكلية:</b>\r\n" الريادة في التعليم والبحث في إدارة الأعمال للمساهمة في بناء اقتصاد المعرفة\r\n<br>\r\n<br>\r\n<b>أقسام الكلية:</b>\r\nقسم الإدارة، قسم الإدارة الصحية، قسم الإدارة العامة، قسم الإقتصاد، قسم التسويق، قسم المالية، قسم المحاسبة، قسم نظم المعلومات الإدارية، وقسم التحليل الكمي', 'logo\\cbaLogo.png'),
(18, 'cfas', 'كلية علوم الأغذية والزراعة', '."\r\n<b>رؤية الكلية:</b>\r\n " التميز في التعليم والتعلم والبحث العلمي وخدمة المجتمع في مجالات الأمن المائي والغذائي والتنمية الزراعية المستدامة\r\n<br>\r\n<br>\r\n<b>أقسام الكلية:</b>\r\nقسم الإنتاج النباتي، قسم الهندسة الزراعية، قسم الإنتاج الحيواني، قسم علوم التربة، قسم الاقتصاد الزراعي، قسم علوم الأغذية والتغذية، قسم الإرشاد الزراعي والمجتمع الريفي، وقسم وقاية النبات', 'logo\\cafsLogo.png'),
(19, 'cap', 'كلية العمارة والتخطيط', '\r\n."\r\n<b>رؤية الكلية:</b>\r\n " التميز عالمياً في بناء المعرفة في علوم البيئة المبنية\r\n<br>\r\n<br>\r\n.\r\n<b>أٌقسام الكلية:</b>\r\nقسم العمارة وعلوم البناء وقسم التخطيط العمراني', 'logo\\ksuLogo.png');
